...
public class ConstantUtil {
	...
	public final static String Portfolio_Recommend = "Portfolio recommend";
	
	public final static String SupplyChain_Recommend = "Supply chain recommend";
	
	public final static String Orange_Validation = "Orange Validation";
	
	public final static String ROLE_PortfolioManager = "portfolioManager";
	
	public final static String ROLE_CountryManager = "countryManager";
